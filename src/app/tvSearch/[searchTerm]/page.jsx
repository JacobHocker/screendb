...
export default function TvSearchPage({ params }) {
    ...
    useEffect(() => {
        fetch(`${process.env.NEXT_PUBLIC_API_URL}search/tv?api_key=${process.env.NEXT_PUBLIC_API_KEY}&query=${params.searchTerm}&language=en-US&page=${pageNumber}&include_adult=false`)
        .then((r) => r.json())
